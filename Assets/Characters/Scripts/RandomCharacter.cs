...
public class RandomCharacter : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string upperArmPath = LoadRandomBodyPath();
        ...
        string lowerArmPath = LoadRandomBodyPath();
        ...
        string handPath = LoadRandomBodyPath();
        leftHand = InstantiateBodyPart(Resources.Load(charactersDir + handPath + "/" + BodyParts.LeftHand), leftLowerArm);
        rightHand = InstantiateBodyPart(Resources.Load(charactersDir + handPath + "/" + BodyParts.RightHand), rightLowerArm);
